...
The Quebec box plot is shorter and higher compare to the Mississippi one.
...
This means that the lower quartile of Quebec box plot has upper values for uptake rates than the upper quartile of Mississippi box plot has. 
...
The chilled box plot is lower and more spread out than the non chilled one.
...
The chilled box plot is shorter and lower compare to the non chilled one:
...
This first approach on CO2 data set gives us the ability to predict treatment and type depending on uptake rates and inversely uptake rates depending on treatment and type.

The most precise **logistic model**  on type confirms what we saw in the data visualization part where box plot from Quebec and Mississippi had huge difference in their quartiles and median.This model can easily predict the type of plants based on the CO2 uptake rates.
The second one is the **linear regression model** which predicts uptake rates based on type and treatment given. The results are not as precise as we want them to be.
